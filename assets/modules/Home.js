...
class Home {
    ...
    getUserInformations() {
        ...
        fetch("https://api.github.com/users/PelApY")
    ...
    async getReposInformations() {
        ...
        // URL de l'API clasisque : https://api.github.com/users/PelApY/repos
        const octokit = new Octokit()
        const response = await octokit
            .request("GET /users/PelApY/repos")
            .catch((error) => {
        ...
        // https://api.github.com/repos/PelApY/{nom-du-repo}/languages
